...
namespace WebApp.Areas.Admin.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        {
            if (HttpContext.Session.GetString("AUserId") == null || HttpContext.Session.GetString("AUserId") == "") { return RedirectToAction("Login", "Admin"); }
            return View();
        }
        ...
        {
            if (HttpContext.Session.GetString("AUserRole") == "Admin") { return RedirectToAction("Login", "Admin"); }
            return View();
        }
        [HttpGet]
